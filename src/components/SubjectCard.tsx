    ...
    >
      ...
      <div className="relative z-10 p-8">
        ...
        <div className="flex items-center justify-between">
          <button className="group/btn relative overflow-hidden bg-gradient-to-r from-engineering-blue via-blue-600 to-tech-cyan text-white px-8 py-4 rounded-2xl font-semibold text-sm flex items-center gap-3 hover:shadow-2xl transition-all duration-500 hover:scale-110">
